...
{
    0x7A, 0x69, 0x6B, 0x6C, 0x61, 0x57, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x00, 0x90, 0x00, 0x00,
};

CONST uint8 multiProfilechar1UUID[ATT_UUID_SIZE] =
{
    0x7A, 0x69, 0x6B, 0x6C, 0x61, 0x57, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x01, 0x90, 0x00, 0x00,
};

CONST uint8 multiProfilechar2UUID[ATT_UUID_SIZE] =
{
    0x7A, 0x69, 0x6B, 0x6C, 0x61, 0x57, 0x00, 0x80, 0x00, 0x10, 0x00, 0x00, 0x02, 0x90, 0x00, 0x00,
};
#endif
...
static uint8 multiProfileChar1Props = GATT_PROP_WRITE |GATT_PROP_WRITE_NO_RSP;
